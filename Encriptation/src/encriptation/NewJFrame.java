...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            byte[] mensajeBytes = jTextArea1.getText().getBytes("UTF8");

            rsaCipher.init(Cipher.ENCRYPT_MODE, clave.getPublic());
            mensajeCifrado = rsaCipher.doFinal(mensajeBytes);

            String mensajeCifradoStr = new String(mensajeCifrado, "UTF8");
            jTextArea2.setText(mensajeCifradoStr);
